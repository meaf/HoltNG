...
public class MainUI extends UI {
    ...
    private MGrid<User> list = new MGrid<>(User.class)
    ...
    protected void init(VaadinRequest request) {
        DisclosurePanel aboutBox = new DisclosurePanel("Spring Boot JPA CRUD example with Vaadin UI", new RichText("Hello"));
        setContent(
                new MVerticalLayout(
                        aboutBox,
        ...
        list.setDataProvider(
                ...
                (sortOrder, offset, limit) -> {
                    ...
                    if (startPage != endPage) {
                        List<User> page0 = repo.findByNameLikeIgnoreCase(likeFilter, PageRequest.of(startPage, pageSize, sortDirection, sortProperty));
                        page0 = page0.subList(offset % pageSize, page0.size());
                        List<User> page1 = repo.findByNameLikeIgnoreCase(likeFilter, PageRequest.of(endPage, pageSize, sortDirection, sortProperty));
                        page1 = page1.subList(0, limit - page0.size());
                        List<User> result = new ArrayList<>(page0);
                        result.addAll(page1);
    ...
    protected void edit(final User phoneBookEntry) {
